...
<div class="bg-white rounded-2xl shadow-lg overflow-hidden">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 p-6">
        ...
        <h2 class="text-3xl font-bold text-white">
            ✏️ Edit Observasi Guru
        </h2>

        <p class="text-blue-100 mt-2">
            Perbarui data hasil observasi pembelajaran guru.
        </p>
...
<form action="{{ route('observasi.update', $observasi->id) }}" method="POST">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input
                        type="text"
                        name="nama_guru"
                        value="{{ old('nama_guru', $observasi->nama_guru) }}"
                ...
                <div>
                    ...
                    <input
                        type="text"
                        name="mata_pelajaran"
                        value="{{ old('mata_pelajaran', $observasi->mata_pelajaran) }}"
                        class="w-full border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden mb-6">
        ...
        <div class="p-6">
            ...
            <input
                ...
                value="{{ old('tanggal_observasi', $observasi->tanggal_observasi) }}"
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input
                        type="number"
                        name="persiapan"
                        value="{{ old('persiapan', $observasi->persiapan) }}"
                ...
                <div>
                    ...
                    <input
                        type="number"
                        name="pelaksanaan"
                        value="{{ old('pelaksanaan', $observasi->pelaksanaan) }}"
                        class="w-full border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-orange-500">
                ...
                <div>
                    ...
                    <input
                        type="number"
                        name="penilaian"
                        value="{{ old('penilaian', $observasi->penilaian) }}"
                        class="w-full border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-orange-500">
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('pengelolaan_kelas', $observasi->pengelolaan_kelas) }}"
                        class="w-full border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-orange-500">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden mb-6">
        ...
        <div class="p-6">
            ...
            <textarea
                ...
                placeholder="Masukkan catatan hasil observasi...">{{ old('catatan', $observasi->catatan) }}</textarea>
